...
if __name__ == '__main__':
    src_kompiled_dir = sys.argv[1]  # usually .build/defn/coverage/llvm/kwasm-polkadot-host-kompiled
    dst_kompiled_dir = sys.argv[2]  # usually .build/defn/kwasm/haskell/kwasm-polkadot-host-kompiled
