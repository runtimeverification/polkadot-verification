...
WASM_definition = pyk.readKastTerm('.build/defn/kwasm/llvm/wasm-with-k-term-kompiled/compiled.json')

WASM_symbols = pyk.buildSymbolTable(WASM_definition)
...
if __name__ == '__main__':
    ...
    fastPrinted = pyk.prettyPrintKast(initial_configuration['args'][0], WASM_symbols)
